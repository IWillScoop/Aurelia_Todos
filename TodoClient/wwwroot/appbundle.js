...
System.register("todos/todoData", ["npm:babel-runtime@5.5.6/helpers/create-class", "npm:babel-runtime@5.5.6/helpers/class-call-check", "github:aurelia/framework@0.12.0", "github:aurelia/http-client@0.9.1"], function (_export) {
    var _createClass, _classCallCheck, inject, HttpClient, baseUrl, parse, TodoData;
    ...
    return {
        ...
        execute: function () {
            ...
            baseUrl = "http://localhost:57849/api/Todos";
            ...
            TodoData = (function () {
                function TodoData(httpClient) {
                    _classCallCheck(this, _TodoData);
                ...
                var _TodoData = TodoData;

                _createClass(_TodoData, [{
                    key: "getById",
                ...
                TodoData = inject(HttpClient)(TodoData) || TodoData;
                return TodoData;
            })();

            _export("TodoData", TodoData);
        }
    };
});
System.register('todos/list', ['npm:babel-runtime@5.5.6/helpers/create-class', 'npm:babel-runtime@5.5.6/helpers/class-call-check', 'github:aurelia/framework@0.12.0', 'todos/todoData'], function (_export) {
    var _createClass, _classCallCheck, inject, TodoData, List;
    ...
    return {
        setters: [function (_npmBabelRuntime556HelpersCreateClass) {
            ...
            inject = _githubAureliaFramework0120.inject;
        }, function (_todosTodoData) {
            TodoData = _todosTodoData.TodoData;
        }],
        execute: function () {
            'use strict';
            ...
            List = (function () {
                ...
                _createClass(_List, [{
                    ...
                    value: function activate() {
                        ...
                        return this.data.getAll().then(function (todos) {
                            return _this.todos = todos;
                        });
                    }
                }]);

                List = inject(TodoData)(List) || List;
                return List;
            })();
...
System.register("todos/edit", ["npm:babel-runtime@5.5.6/helpers/create-class", "npm:babel-runtime@5.5.6/helpers/class-call-check", "github:aurelia/framework@0.12.0", "github:aurelia/validation@0.2.5", "todos/todoData", "github:aurelia/router@0.9.0"], function (_export) {
    var _createClass, _classCallCheck, inject, Validation, TodoData, Router, Edit;
    ...
    return {
        ...
        execute: function () {
            ...
            Edit = (function () {
                function Edit(todoData, validation, router) {
                    _classCallCheck(this, _Edit);

                    this.data = todoData;
                    this.router = router;
                    this.validation = validation.on(this).ensure("todo.Title").isNotEmpty().hasMinLength(3).hasMaxLength(100).ensure("todo.Note").isNumber().isBetween(1900, 2100);
                }
                ...
                _createClass(_Edit, [{
                    ...
                    value: function activate(params) {
                        ...
                        if (params.id) {
                            this.data.getById(params.id).then(function (todo) {
                                _this.todo = todo;
                    ...
                    value: function save() {
                        ...
                        this.validation.validate().then(function () {
                            return _this2.data.save(_this2.todo);
                        }).then(function (todo) {
                            console.log(todo);
                            var url = _this2.router.generate("details", { id: todo.Id });
                            _this2.router.navigate(url);
                        });
                    }
                }]);

                Edit = inject(TodoData, Validation, Router)(Edit) || Edit;
                return Edit;
            })();
...
System.register('todos/details', ['npm:babel-runtime@5.5.6/helpers/create-class', 'npm:babel-runtime@5.5.6/helpers/class-call-check', 'github:aurelia/framework@0.12.0', 'todos/todoData'], function (_export) {
    var _createClass, _classCallCheck, inject, TodoData, Details;
            ...
            Details = (function () {
                ...
                _createClass(_Details, [{
                    ...
                    value: function activate(params) {
                        ...
                        return this.data.getById(params.id).then(function (todo) {
                            return _this.todo = todo;
                        });
                    }
                }]);

                Details = inject(TodoData)(Details) || Details;
                return Details;
            })();
            ...
            App = (function () {
                ...
                _createClass(App, [{
                    ...
                    value: function configureRouter(config, router) {
                        ...
                        config.title = "Todos";
                        config.map([{ route: "", name: "home", moduleId: "todos/list", title: "List", nav: true }, { route: "about", moduleId: "about/about", title: "About", nav: true }, { route: "details/:id", name: "details", moduleId: "todos/details" }, { route: "edit/:id", name: "edit", moduleId: "todos/edit" }, { route: "create", name: "create", moduleId: "todos/edit" }]);
                    }
                }]);
